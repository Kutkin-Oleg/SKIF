...
def main():
    ...
    beamLine.alignE = E0
    beamLine.bentLaueCylinder01.Rx = -1500
    beamLine.bentLaueCylinder02.Rx = -1500
    beamLine.bentLaueCylinder01.Ry = 1500*1.e6
    beamLine.bentLaueCylinder02.Ry = 1500*1.e6
